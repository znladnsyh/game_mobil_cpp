...
int main()
{
 ...
 float fSpk = 0;
  ...
  {
    system("cls");
    tulisTengah(" CAR by znladnsyh", 10);
    tulisTengah("==============================", 11);
  ...
  system("cls");
    ...
    spk -= iJarak / 200;
    system("cls");
    gotoxy(20, 12); cout << "Game End - Skor Anda    : " << (iJarak / spk) + pemainUtama.darah * 100;
    gotoxy(20, 13); cout << "Total Waktu Bermain      : " << (clock() - before) / 1000 << " Detik";
    tulisTengah("Thank You ", 17);
    
    tulisTengah("Created github.com/znladnsyh", 19);
    tulisTengah("=========================================", 20);
    tidur(5000);
    getch();
}
